 ...
 * moved to `src/geom` (ruling Q-I2-59) so DRC and the router's clearance queries
 * (src/route/clear.ts) share one copy; both are re-exported here for callers of this module.
 *
...
import { coreOf, cross, crossesEdge, dist2PtPt, dist2PtSeg, dist2Pts, dot, pointInConvex, segsIntersect, withinRim } from "../geom/index.ts";
...
// crossesEdge / withinRim now live in src/geom (ruling Q-I2-59); re-exported so callers of this
// module keep importing them from `../drc/exact.ts`.
export { crossesEdge, withinRim };
