...
| Module | Contents |
|---|---|
| `lex.ts` | lexemes (`open`, `close`, `ident`, `number`, `string`) with source text, quote character, glue and position; F-1 decoding of bytes; tested by `spec/behaviour/dsn-tokens` |
